...
[Shot 1] marks the opening shot and has no timestamp: never write "At 00:00.000" or any other timestamp after [Shot 1]. Later shots use [Shot 2] At MM:SS.mmm, ... to mark cut times that are strictly increasing, greater than zero, and fall within the duration N. The timestamp is always zero-padded: MM is exactly two digits, SS is exactly two digits, mmm is exactly three digits (00:04.000, never 00:4.000).
At the first clear appearance of an important <Subject N>, describe its referenced characteristics, its position in the frame, and its current action. In every subsequent shot, refer to the subject exclusively by its <Subject N> label: never re-describe its appearance, name, clothing, or which shot it first appeared in. Use natural phrasing for concrete frame anchors: "the shot begins from <Picture 1>", "the shot's keyframe corresponds to <Picture 2>", "the shot ends on <Picture 3>". Cite <Picture N> only in these frame-anchor cases; for every other referenced content use the <Subject N> label. Never add parenthetical source attributions: no "(referenced from <Picture 1>, <Picture 2>)", no "(from <Video 2>)", no "(based on the reference)". Provenance is stated once in subject_definitions; in this section the label is part of the sentence itself, not a citation note. Always use <Subject N> to refer to the established subjects; never substitute a character name, an appearance description, or "the man/woman from Shot X" for the label. A pronoun is permitted only within a single sentence that already contains the <Subject N> label and where the referent is unambiguous. When editing or continuing an original video, cite <Video N> where its source state, structure, or continuation relationship applies. Cite <Audio N> in the shot or semantic phase where the audio relationship is active and state whether the signal is copied or referenced.
...
[Shot 2] At 00:03.000, the shot cuts to a close-up of <Subject 4> (S2) sitting beside <Subject 3> on the sofa and holding <Subject 2> securely in his arms. <Subject 4> (S2) says in a casual young male voice with a playful tone and an easy conversational pace: <d>[English] He just likes cookies more than me.</d> <Subject 4> closes his mouth into an apologetic smile and strokes <Subject 2>'s thick white fur.
[Shot 3] At 00:05.000, the shot cuts to a close-up of <Subject 3> (S1). <Subject 3> (S1) looks toward <Subject 2> with softening annoyance, then replies in the same clear youthful voice referenced from <Audio 1> with an amused cadence: <d>[English] Well, he has good taste at least.</d> <Subject 3> (S1) smiles and raises the cookie in a small toast-like gesture. A classic canned audience laugh begins immediately after the line and continues through the final frame.
