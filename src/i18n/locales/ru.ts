...
const translation = {
    controls: {
        ...
        send_to: 'Отправить в...',
        rel_l1_thresh: 'порог TeaCache',
        start_percent: 'начало TeaCache',
        end_percent: 'конец TeaCache',
    ...
    help: {
        ...
        tea_cache_start:
            'TeaCache активируется с этого шага (задаётся как доля от общего числа шагов). Увеличьте значение, если видео содержит артефакты движения, чтобы больше шагов в начале генерации было рассчитано полностью, без ускорения. Ранние шаги определяют общую структуру видео, а поздние шаги улучшают мелкие детали.',
        tea_cache_end:
            'TeaCache перестанет работать после этого шага (задаётся как доля от общего числа шагов). Уменьшите значение, если вам нужно больше деталей. Ранние шаги определяют общую структуру видео, а поздние шаги улучшают мелкие детали.',
        guidance:
