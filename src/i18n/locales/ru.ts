...
const translation = {
    ...
    help: {
        ...
        lora: 'LoRA (low-rank adaptation) — это метод добавления новых концептов в модель, таких как персонажи (люди), движения, жесты, стили и т.п. Вы можете комбинировать несколько лор с разными весами. Если вы замечаете странные артефакты, попробуйте уменьшить веса лор, особенно, если вы используете несколько одновременно.',
    },
    toasts: {
