...
const translation = {
    controls: {
        ...
        inpaint_crop: 'inpaint crop',
        inpaint_crop_settings: 'Inpaint Crop Settings',
        mask_expand_pixels: 'mask expand',
        mask_blend_pixels: 'blend',
        context_expand_factor: 'context factor',
        ...
        tab_timings_diff: 'Timings',
        timings_other: 'other',
        no_timings: 'No timings recorded',
        ...
        latent_upscale_seed: 'upscale seed',
        sparse_attention: 'Sparse Attention',
        sparse_attention_video_budget: 'Sparse Attention video budget',
        sparse_attention_denser_early_late_steps: 'Denser early/late steps',
        send_back: 'Send back',
        ...
        style: 'style',
        abc_planning: 'ABC planning',
        abc: 'ABC notation',
        abc_notation: 'Generated ABC',
        abc_send_to_field: 'Send to ABC field',
        abc_send_to_tab: 'Send to YuE2 tab',
        abc_empty: 'No ABC notation yet',
        abc_mode: 'ABC mode',
        music_mode: 'Music mode',
        mode_full: 'Full (melody + chords)',
        mode_melody: 'Melody only',
        ...
        ref_megapixels: 'target megapixels',
        scale_match: 'match',
        scale_max: 'max',
        scale_scale: 'scale',
        ...
        chat_title: 'Chat',
        chat_placeholder: 'Ask for prompt improvements...',
        chat_send: 'Send',
        chat_avatar_user: 'User',
        ...
        chat_mode: 'Chat mode',
        yue2_chat_mode_generation: 'Generation',
        yue2_chat_mode_editing: 'Editing',
    ...
    settings: {
        ...
        llm_model: 'LLM model',
        llm_supports_video: 'LLM video support',
        llm_supports_audio: 'LLM audio support',
        override_auto: 'Auto (from config)',
        override_on: 'On',
        override_off: 'Off',
    ...
    presets: {
        ...
        toggle_params: 'Toggle parameters',
        total_size: '%{size} total',
        add_file: 'Add file',
        replace_file: 'Replace',
        missing_server: 'File not found on the ComfyUI server',
        no_local_copy: 'No local copy stored',
        collect_failed: 'Failed to download the file',
        saved: 'Preset saved',
        save: 'Save',
        edit: 'Edit preset',
        tab_label: 'Tab',
    ...
    arena: {
        ...
        exit: 'Exit selection mode',
        start: 'Start arena',
        start_min: 'Need at least 2 participants to start',
        resume: 'Resume voting',
        continue: 'Continue voting',
        finish: 'Finish arena',
        progress: '%{done} / %{total} matches',
        ...
        b: 'B',
        choose: 'Choose %{name}',
        vote_this: 'Vote for this',
        view_full: 'View full size',
        exhausted: 'All pairs exhausted',
        points: '%{n} pts',
        wl: '%{w} wins – %{l} losses',
    ...
    refmods: {
        ...
        crop_title: 'Crop Reference Images',
        crop_aspect: 'Target aspect',
        crop_out: 'Crop output',
        crop_apply: 'Crop',
        crop_load_failed: 'Failed to load the image',
        crop_failed: 'Failed to crop the image: %{err}',
        mod_resolution: 'Mod resolution',
        over_budget: 'over token budget',
        video_note: '+%{n} video',
    },
    errors: {
